...
public class TestClass_UsingPropertyConcept_KiteAppWrongPass extends Base_PropertyConcept_KiteClass {
	...
	@BeforeMethod
	 ...
	 @Test
	  public void Validate_User() throws EncryptedDocumentException, IOException {
		...
		String ExpectedUserID = Utility_UsingPropertyFile_KiteClass.ReadDataFromPropertyFile("User_Name1"); //we get expected id from the excel sheet which we declare in utilityclass and in that inside the read excel method
